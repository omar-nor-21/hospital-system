import TableHead from "@/components/table/TableHeading";
            ...
            <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <TableHead name={"Name"} phone={"Phone"} doj={"Date of Joining"} blood={"Blood Group"} emgr="Emergency Contact"/>
                        <tbody>
                            {doctors.map((doctor) => (
                                <tr className="border-b dark:border-gray-700">
                                    <td className="px-4 py-3">{doctor.name}</td>
                                    <td className="px-4 py-3">{doctor.phone}</td>
                                    <td className="px-4 py-3">{doctor.emergency_contact}</td>
                                    <td className="px-4 py-3">{doctor.blood_group}</td>
                                    <td className="px-4 py-3">{doctor.doj}</td>
